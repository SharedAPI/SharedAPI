package fr.traqueur.shared.api.updater;
...
public class Updater {
    ...
    public static void checkUpdates() {
        if(!Updater.isUpToDate()) {
            Logger.getLogger("SharedAPI")
                    .warning("The framework is not up to date, the latest version is " + Updater.fetchLatestVersion());
        }
    }
    ...
    public static String fetchLatestVersion() {
        try {
            URL url = URI.create("https://api.github.com/repos/SharedAPI/SharedAPI/releases/latest").toURL();
